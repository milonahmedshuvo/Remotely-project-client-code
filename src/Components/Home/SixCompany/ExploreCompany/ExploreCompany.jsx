        ...
        <div className="w-full mt-5  ">
          ...
          <div className="px-0 lg:px-28">
            ...
            <div className="bg-[#FFFFFF] py-8  relative top-[-100px] ">
              <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div className="flex flex-col lg:flex-row items-center  pr-4">
                  <p className="mr-6 bg-[#007BFF] px-8 py-2 text-white text-lg  rounded-3xl">
                    Post
                  </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 bg-[#FFFFFF] pt-5 pb-5 mt-[-60px]">
              <Link
                to={`/DainamicRoute/${_id}`}
                className="text-[#213547] mt-6 hover:bg-blue-300 duration-500 ease-linear py-5 "
              >
              ...
              <Link
                className="text-[#213547] hover:bg-blue-300 py-5 duration-500 ease-in-out"
                to={`/DainamicRoute/${_id}/${companyName}`}
              >
                <div className="flex flex-col items-center justify-center">
                  <h3>
                    {" "}
